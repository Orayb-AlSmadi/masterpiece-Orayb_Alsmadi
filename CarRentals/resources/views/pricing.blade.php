...
@section('content')
   <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('{{asset('/images/about.jpg')}}')" data-stellar-background-ratio="0.5">
                ...
                <div class="col-md-12 ftco-animate">
                    <div class="car-list">
                        <table class="table">
                            ...
                            <tbody>
                            <tr class="">
                                <td class="car-image"><div class="img" style="background-image:url('{{asset('/images/bg_1.jpg')}}')"></div></td>
                            ...
                            <tr class="">
                                <td class="car-image"><div class="img" style="background-image:{{url('/images/bg_1.jpg')}}"></div></td>
                                <td class="product-name">
                                    <h3>Cheverolet SUV Car</h3>
                                    <p class="mb-0 rated">
                                        <span>rated:</span>
